...
$docstatus=1;
	...
	if($query)
	{
		echo "<script>alert('Your item booked successfully');</script>";
	}
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User | Order status</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Guest List</h5>
												</div>
